...
ERROR_CODEBOOK = {
    ...
    "extraneous_solution": "The response includes a candidate that fails substitution into the original constraints.",
    "incomplete_solution": "The response stops before satisfying every requested component.",
    "incomplete_expression_evaluation": "The final answer is only a proper subexpression of the required expression.",
    "matrix_element_error": "At least one matrix entry differs at a verified row and column.",
    "vector_component_error": "At least one vector component differs at a verified index.",
    "format_only_difference": "The typed evaluator proves equivalence and only presentation differs.",
